...
(function() {
  var ROOT, benchmark, cache, compileTemplate, crypto, decorate, errMsg, fs, getCached, getCss, getTemplate, highlight, hljs, jade, less, markdownIt, modifyUriTemplate, moment, path, querystring, renderAttributes, renderExample, renderSchema, sha1, slug;
  ...
  // match the resource to the it's special host if set
  getResourceHost = function(section, hosts) {
    for (host in hosts) {
      var processed_section = section.replace(" ","");
      var processed_host = host.replace("HOST-","").replace ("-","");
      if (processed_section == processed_host) {
        return hosts[host];
      }
    }  
    return hosts["HOST"];
  ...
  decorate = function(api, md, slugCache, verbose) {
    var hosts, action, category, dataStructure, dataStructures, err, example, i, item, j, k, knownParams, l, len, len1, len2, len3, meta, name, newParams, param, ref, ref1, ref2, ref3, resource, resourceGroup, results, reversed, schema, slugify;
    ...
    // loop through all the host metadata and add to object
    hosts = {}
    ref2 = api.metadata || [];
    for (k = 0, len2 = ref2.length; k < len2; k++) {
      meta = ref2[k];
      if (meta.name.startsWith('HOST')) {
        api.host = meta.value;
        hosts[meta.name] = meta.value;
      }
    }
        ...
        for (m = 0, len4 = ref4.length; m < len4; m++) {
          ...
          results1.push((function() {
            ...
            for (n = 0, len5 = ref5.length; n < len5; n++) {
              ...
              metaHosts = hosts;
              action.getResourceHost = getResourceHost(resource.name, hosts);
                  ...
                  results3.push((function() {
                    ...
                    for (q = 0, len8 = ref7.length; q < len8; q++) {
                      ...
                      results4.push((function() {
                        var len10, len11, len12, len13, len9, r, ref10, ref11, ref12, ref8, ref9, results5, s, t, u, w;
                        ref8 = example[name] || [];
                        results5 = [];

...
(function() {
  ...
  module.exports = renderAttributes = function(root, dataStructures) {
    var attributes, error, error1, exclusive, i, item, items, j, k, key, len, len1, len2, m, member, option, optionSchema, prop, properties, reducedItems, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, required, typeAttr;
    attributes = {
      values: [],
      properties: []
    };
